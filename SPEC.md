...
| 10b | The reactor split | `messageCreate` split into plugins with a `handled` short-circuit, which makes finding 9 impossible rather than fixed; self-learning keyed by the reply's own message ID. Closes 6, 9 | |
