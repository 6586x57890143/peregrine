...
func clearEnv(t *testing.T) {
	...
	keys := []string{
		...
		"PEREGRINE_ENABLE_WHEEL", "PEREGRINE_WHEEL_PUZZLES", "PEREGRINE_WHEEL_LOBBY",
		"PEREGRINE_WHEEL_MIN_PLAYERS", "PEREGRINE_WHEEL_MAX_PLAYERS", "PEREGRINE_WHEEL_ROUNDS",
		"PEREGRINE_WHEEL_TURN_TIMEOUT", "PEREGRINE_WHEEL_IDLE_STRIKES", "PEREGRINE_WHEEL_MAX_DURATION",
		"PEREGRINE_WHEEL_REPOST_AFTER", "PEREGRINE_WHEEL_ASSET_URL",
